...
from collections import deque
from PIL import Image
from gym.envs import TimeLimit,AtariPreprocessing
...
class ReplayResetEnv(gym.Wrapper):
    ...
    """
    def __init__(self,env,demo,ARGS):
        self.env = env 
        self.demo = demo
        self.score = 0
        self.cur_demo_idx = 0
        ...
        self.allowed_lag = ARGS.allowed_lag
        self.allowed_score_deficit = ARGS.allowed_score_deficit
...
if __name__ == "__main__":
    from loaddemo import Demo
    demo = Demo('Phase2\demos\Pitfall.demo')
    env = build_env('Freeway')
    env = ReplayResetEnv(env,demo)
